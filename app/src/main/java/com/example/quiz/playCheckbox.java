 ...
 * Use the {@link playCheckbox#newInstance} factory method to
 * create an instance of this fragment.
 */
public class playCheckbox extends Fragment {
    ...
    Button time, point, firstText, secondText, thirdText, fourText, nextQuestionButton, answerButton;
    TextView question;
    int score = 0;
     ...
     * @return A new instance of fragment playCheckbox.
     */
    // TODO: Rename and change types and number of parameters
    public static playCheckbox newInstance(String param1, String param2) {
        playCheckbox fragment = new playCheckbox();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_play_checkbox, container, false);
        ...
        firstIcon = view.findViewById(R.id.firstIcon);
        secondIcon = view.findViewById(R.id.secondIcon);
        thirdIcon = view.findViewById(R.id.thirdIcon);
        fourIcon = view.findViewById(R.id.fourIcon);
        select_done = view.findViewById(R.id.select_done);
        viewPanel = view.findViewById(R.id.view);
                    ...
                    public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                        if (Integer.parseInt(String.valueOf(value.getString(Constants.COUNT_ANSWERED))) == Integer.parseInt(String.valueOf(value.get(Constants.COUNT_USER)))){
                            ...
                            if (preferenceManager.getString(Constants.KEY_USER_ID).equals(creatorId)){
                                ((quiz_friend)view.getContext()).hideCheckbox();
                            } else {
                                ((quiz_friend_user)view.getContext()).hideCheckbox();
                            }
                        }
                    }
                });
        ...
        nextQuestionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ((quiz_solo)view.getContext()).hideCheckbox();
                } catch (Exception e){
                    Toast.makeText(view.getContext(), e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        ...
        answerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!firstIcon.isChecked() && !secondIcon.isChecked() && !thirdIcon.isChecked() && !fourIcon.isChecked()){
                    Toast.makeText(view.getContext(), "Выберите вариант ответа", Toast.LENGTH_SHORT).show();
                } else {
                    if (type.equals("friend")){
